...
function docked {
    ...
    xrandr --output VIRTUAL1 --off --output eDP1 --off --output DP1 --primary --mode 1920x1200 --pos 0x0 --rotate normal --output HDMI2 --off --output HDMI1 --off --output DP2 --off >> /home/tom/test.log 2>&1
}
function mobile {
...
function both {
    ...
    xrandr --output VIRTUAL1 --off --output eDP1 --mode 1366x768 --pos 288x1200 --rotate normal --output DP1 --primary --mode 1920x1200 --pos 0x0 --rotate normal --output HDMI2 --off --output HDMI1 --off --output DP2 --off
