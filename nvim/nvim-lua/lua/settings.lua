...
vim.o.relativenumber = true -- relative to position
...
vim.o.textwidth = 80
vim.o.formatoptions = 'qrn1' -- q  - comment formatting; n - numbered lists; j - remove comment when joining lines; 1 - don't break after one-letter word
